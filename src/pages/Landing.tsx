  ...
  const edges: FlowEdge[] = [
    {
      ...
      from: "oem",
      to: "customer",
      path: "M172 294 C192 260 252 246 320 240",
    ...
    },
    {
      ...
      from: "customer",
      to: "consulting",
      path: "M468 166 C502 184 526 250 546 294",
      label: content.solution.flow.product,
      labelX: 506,
      labelY: 206,
      duration: 7.8,
    ...
    },
    {
      ...
      from: "consulting",
      to: "disassembly",
      path: "M665 294 C674 264 704 246 755 240",
    ...
    },
    {
      ...
      from: "disassembly",
      to: "smelter",
      path: "M816 240 C872 248 928 274 950 294",
    ...
    },
    {
      ...
      from: "consulting",
      to: "smelter",
      path: "M672 368 C728 358 792 358 852 372",
      label: content.solution.flow.pcb,
      labelX: 748,
      labelY: 348,
      duration: 7.6,
    ...
    },
    {
      ...
      from: "smelter",
      to: "consulting",
      path: "M852 412 C792 430 726 430 672 412",
    ...
    },
    {
      ...
      from: "smelter",
      to: "materials",
      path: "M934 434 C858 500 744 568 678 584",
    ...
    },
    {
      ...
      from: "materials",
      to: "oem",
      path: "M442 584 C352 566 244 512 200 438",
