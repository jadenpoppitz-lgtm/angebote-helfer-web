  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col overflow-hidden bg-foreground md:flex-row">
      ...
      <Link
        ...
        className={`group relative isolate flex min-h-[60vh] w-full overflow-hidden transition-[flex-grow,flex-shrink,flex-basis] duration-[8000ms] ease-[cubic-bezier(0.16,1,0.3,1)] will-change-[flex] motion-reduce:transition-none md:min-h-screen ${produzentFlex}`}
      >
        <img
          src="https://images.unsplash.com/photo-1700727448686-b314cb5f9948?w=1400&h=1600&fit=crop&auto=format"
          alt="Produktionshalle"
          className="absolute inset-0 h-full w-full object-cover grayscale-[40%] transition-transform duration-[12000ms] ease-[cubic-bezier(0.16,1,0.3,1)] will-change-transform motion-reduce:transition-none group-hover:scale-[1.025]"
        />
        <div className="absolute inset-0 bg-foreground/55 transition-colors duration-[4200ms] ease-[cubic-bezier(0.16,1,0.3,1)]" />
        <div className="absolute inset-0 bg-[hsl(152_55%_14%)]/45 mix-blend-multiply transition-colors duration-[4200ms] ease-[cubic-bezier(0.16,1,0.3,1)]" />
        ...
        <div className="relative z-10 mt-auto flex w-full flex-col items-start gap-4 p-8 text-background md:p-14">
          <span className="text-xs font-semibold uppercase tracking-[0.3em] text-background/80 transition-all duration-[2600ms] ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:tracking-[0.35em]">
            {t.producer}
          </span>
          <h2 className="font-display text-3xl font-semibold leading-tight transition-all duration-[2600ms] ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:translate-x-1 md:text-5xl">
            {producerTitleA}
            <br />
            {producerTitleB}
          </h2>
          <p className="max-w-md text-sm text-background/85 transition-all duration-[3000ms] ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:translate-x-1 md:text-base">
            {t.producerText}
          </p>
          <span className="mt-2 inline-flex h-12 items-center gap-2 rounded-full bg-background px-6 font-medium text-foreground shadow-elegant transition-all duration-[2400ms] ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:translate-x-2">
            {t.firstCall}
      ...
      <div
        ...
        onMouseLeave={() => setHover(null)}
        className={`group relative isolate flex min-h-[60vh] w-full overflow-hidden transition-[flex-grow,flex-shrink,flex-basis] duration-[8000ms] ease-[cubic-bezier(0.16,1,0.3,1)] will-change-[flex] motion-reduce:transition-none md:min-h-screen ${kundeFlex}`}
      >
        <img
        ...
        />
        <div className="absolute inset-0 bg-foreground/55 transition-colors duration-[4200ms] ease-[cubic-bezier(0.16,1,0.3,1)]" />
        <div className="absolute inset-0 bg-[hsl(28_45%_14%)]/40 mix-blend-multiply transition-colors duration-[4200ms] ease-[cubic-bezier(0.16,1,0.3,1)]" />
        <div className="absolute inset-0 bg-gradient-to-t from-foreground/80 via-foreground/30 to-transparent" />
        <div className="relative z-10 mt-auto flex w-full flex-col items-start gap-4 p-8 text-background md:p-14">
          <span className="text-xs font-semibold uppercase tracking-[0.3em] text-background/80 transition-all duration-[2600ms] ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:tracking-[0.35em]">
            {t.customer}
