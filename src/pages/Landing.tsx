  ...
  const edges: FlowEdge[] = [
    {
      ...
      from: "oem",
      to: "customer",
      path: "M172 290 C190 254 250 232 320 228",
    ...
    },
    {
      ...
      from: "customer",
      to: "consulting",
      path: "M468 154 C500 166 524 244 546 290",
      label: content.solution.flow.product,
      labelX: 506,
      labelY: 206,
      duration: 7.8,
    ...
    },
    {
      ...
      from: "consulting",
      to: "disassembly",
      path: "M665 290 C672 258 698 232 755 228",
    ...
    },
    {
      ...
      from: "disassembly",
      to: "smelter",
      path: "M816 228 C872 238 928 272 950 290",
