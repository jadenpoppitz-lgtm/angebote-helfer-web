  ...
  const edges: FlowEdge[] = [
    {
      ...
      from: "oem",
      to: "customer",
      path: "M162 318 C150 282 158 246 198 234",
    ...
    },
    {
      ...
      from: "customer",
      to: "consulting",
      path: "M304 154 C360 160 396 252 428 334",
      label: content.solution.flow.product,
      labelX: 346,
      labelY: 206,
      duration: 7.8,
    ...
    },
    {
      ...
      from: "consulting",
      to: "oem",
      path: "M428 388 C370 416 308 414 262 386",
    ...
    },
    {
      ...
      from: "consulting",
      to: "disassembly",
      path: "M642 296 C658 258 684 238 724 232",
    ...
    },
    {
      ...
      from: "disassembly",
      to: "smelter",
      path: "M818 234 C872 252 936 282 950 306",
    ...
    },
    {
      ...
      from: "consulting",
      to: "smelter",
      path: "M662 370 C724 362 790 362 848 372",
      label: content.solution.flow.pcb,
      labelX: 748,
      labelY: 348,
      duration: 7.6,
    ...
    },
    {
      ...
      from: "smelter",
      to: "consulting",
      path: "M848 412 C790 426 722 426 662 410",
    ...
    },
    {
      ...
      from: "smelter",
      to: "asia",
      path: "M934 462 C900 514 852 556 830 582",
    ...
    },
    {
      ...
      from: "oem",
      to: "asia",
      path: "M178 472 C304 560 442 612 586 598",
